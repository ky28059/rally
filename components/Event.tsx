...
export default function Event(props: Event & { className?: string }) {
	...
	return (
		<>
			<div
				className={
					'flex flex-col rounded-lg border border-gray-400 hover:border-gray-600 hover:shadow-2xl hover:scale-[1.02] transition duration-200 cursor-pointer overflow-clip'
					+ (open ? ' shadow-2xl scale-[1.02]' : '') 
